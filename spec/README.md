...
### 5. Страница франшизы.
Статическая страница с возможностью изменения контента и принятия заявок на приобретение франшизы.
Необходимо предусмотреть возможность изменения изображения карты в шапке ил количества филиалов (возможно привязать к какой-то общей переменной, т.к. это значение встречается на сайте несколько раз)

<a name="family"></a>

### 6. Страница "Семья".
Страница агрегатор записей о владельцах филиалов франшизы. Возможно стоит предусмотреть "ленивую загрузку"

Каждая запись включает состоит из:
1. Фото владельца
2. Имя
3. Фамилия (может отсутствовать)

<a name="other"></a>

### 7. Остальные страницы.
Статические страницы, которые необходимо предусмотреть:
1. Политика безопасности.
2. Условия использования.
3. Страница 404.
4. Стрижки.
5. Борода и бритьё.
6. Королевское бритьё.

Все эти страницы имеют типовой футер и зачастую типовую шапку (см. макеты).