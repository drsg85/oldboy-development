...
#### 2.7. Футер (1).
Типовой футер страницы филиала (см. Макет), аналогичен типовому футеру с добавлением контактных данных филиала: адрес, телефон, часы работы, название города и ссылки на соцсети. А также ссылки на мобильное приложение.